    ...
    post: ({ data, clientOptions }: {
      data: {
        data: {
          ...
          cursor_last_event_date: Date;
          last_successful_status_check_at: Date;
