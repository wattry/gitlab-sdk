...
export default (client, handler) => ({
  ...
  get: ({query} = {}, options = {}) => handler.apply({method:'get',url:'api/v4/version',headers:{Accept:'application/json'},variable:[],query:[{name:'order_by',type:'string'},{name:'sort',type:'string'}]}, [client, {query}, options])
});