export interface User {
  getOne: ({ clientOptions }: { clientOptions: any }) => Promise<[{ code: 200, data: { id: number, username: string, email: string, name: string, state: string, locked: false, avatar_url: string, web_url: string, created_at: string, bio: string, location: null, public_email: string, skype: string, linkedin: string, twitter: string, discord: string, website_url: string, organization: string, job_title: string, pronouns: string, bot: false, work_information: null, followers: 0, following: 0, local_time: string, last_sign_in_at: string, confirmed_at: string, theme_id: 1, last_activity_on: string, color_scheme_id: 2, projects_limit: 100, current_sign_in_at: string, identities: [{ provider: string, extern_uid: string }, { provider: string, extern_uid: string }, { provider: string, extern_uid: string }], can_create_group: boolean; can_create_project: boolean; two_factor_enabled: boolean; external: false, private_profile: false, commit_email: string } }]>,
  keys: {
...
export default (client: any, handler: any): User => ({
  getOne: ({ clientOptions }: { clientOptions: any }): Promise<[{ code: 200, data: { id: number, username: string, email: string, name: string, state: string, locked: false, avatar_url: string, web_url: string, created_at: string, bio: string, location: null, public_email: string, skype: string, linkedin: string, twitter: string, discord: string, website_url: string, organization: string, job_title: string, pronouns: string, bot: false, work_information: null, followers: 0, following: 0, local_time: string, last_sign_in_at: string, confirmed_at: string, theme_id: 1, last_activity_on: string, color_scheme_id: 2, projects_limit: 100, current_sign_in_at: string, identities: [{ provider: string, extern_uid: string }, { provider: string, extern_uid: string }, { provider: string, extern_uid: string }], can_create_group: boolean; can_create_project: boolean; two_factor_enabled: boolean; external: false, private_profile: false, commit_email: string } }]> => handler.apply({ method: 'get', url: 'api/v4/user', resource: 'user', variable: [{ name: 'key_id', type: 'string' }], headers: { Accept: 'application/json' }, query: [], data: null }, [client, { clientOptions }]),
  "keys": {
