export default (client: any, handler: any) => ({
  ...
  get: ({clientOptions = {}} = {}) => handler.apply({method:"get",url:"api/v4/version",resource:"api",variable:[],headers:{Accept:"application/json"},query:[],data:null}, [client, {clientOptions}])
})